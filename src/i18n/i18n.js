...
const CATALOG = {
  en: {
    ...
    'feat.perf.desc': 'Targets 90-120 FPS on Quest 3 via FFR and object pooling',
    'feat.hand.title': 'Hand Tracking',
    'feat.hand.desc': 'Controller-free interaction with 5 gesture patterns',
  ...
  ja: {
    ...
    'hero.subtitle':
      ...
      'Meta Quest 2/3 と Pico 4 に対応。',
    'cta.enterVR': 'VRモードに入る',
    'feat.perf.title': 'ハイパフォーマンス',
    'feat.perf.desc': 'FFR・オブジェクトプール で Quest 3 90〜120FPS を目標',
    'feat.hand.title': 'ハンドトラッキング',
    'feat.hand.desc': 'コントローラ不要・5種のジェスチャ操作',
