...
const CATALOG = {
  en: {
    ...
    'vr.voice.confirm.volumeUp': 'Increasing volume',
    'vr.voice.confirm.volumeDown': 'Decreasing volume',
    'vr.voice.confirm.imeToggle': 'Japanese input mode',
  ...
  ja: {
    ...
    'vr.voice.confirm.volumeUp': '音量を上げます',
    'vr.voice.confirm.volumeDown': '音量を下げます',
    'vr.voice.confirm.imeToggle': '日本語入力モードです',
