...
export const CATALOG = {
  en: {
    ...
    'feat.perf.desc': 'Targets 90-120 FPS on Quest 3 via foveated rendering, KTX2 textures, and quad-layer UI',
  ...
  ja: {
    ...
    'feat.perf.desc': '中心窩レンダリング・KTX2・クアッドレイヤー UI で Quest 3 90〜120FPS を目標',
