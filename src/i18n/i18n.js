...
export const CATALOG = {
  en: {
    ...
    'hero.subtitle':
      'Accessibility-first WebXR browser with captions, gaze-dwell, Japanese IME, ' +
      'hand tracking, spatial audio, and a comfort system. Targets Meta Quest 2/3 and Pico 4.',
    'cta.enterVR': 'Enter VR Mode',
    'feat.perf.title': 'High Performance',
    'feat.perf.desc': 'Targets 90-120 FPS on Quest 3 via foveated rendering and quad-layer UI',
    'feat.hand.title': 'Hand Tracking',
    'feat.hand.desc': 'Controller-free interaction with 6 gesture patterns',
    ...
    'feat.captions.title': 'In-VR Captions',
    'feat.captions.desc': 'Every status and error rendered as adjustable captions — timing, size, and contrast you control',
    'feat.reader.title': 'Reader View',
    'feat.reader.desc': 'Any page reflowed into clean paginated text, readable at your chosen distance',
    ...
    'vr.content.topSites': 'Top Sites',
    'vr.content.topSitesHint': 'Select a tile to open it',
    ...
    'vr.msg.smoothMoveWarning': 'Smooth move may cause motion sickness',
    ...
    'vr.msg.leftControllerDisconnected': 'Left controller disconnected',
    'vr.msg.rightControllerDisconnected': 'Right controller disconnected',
    'vr.msg.controllerDisconnected': 'Controller disconnected',
    'vr.msg.leftControllerReconnected': 'Left controller reconnected',
    'vr.msg.rightControllerReconnected': 'Right controller reconnected',
    'vr.msg.controllerReconnected': 'Controller reconnected',
    'vr.msg.graphicsPaused': 'Graphics paused — restoring',
    'vr.msg.graphicsRestored': 'Graphics restored',
    'app.loading': 'Loading Qui Browser VR…',
    ...
    'vr.msg.loadFailedPrefix': 'Failed to load',
    ...
    'vr.msg.historyEntryDeleted': 'History entry deleted',
    ...
    'vr.video.exit': 'Exit',
    'vr.video.loadFailed': 'Could not load video (check URL / CORS)',
  ...
  ja: {
    ...
    'hero.subtitle':
      'キャプション・視線ドウェル・日本語IME・ハンドトラッキング・空間オーディオ・コンフォートシステムを備えた' +
      'アクセシビリティ第一の WebXR ブラウザ。Meta Quest 2/3 と Pico 4 に対応。',
    'cta.enterVR': 'VRモードに入る',
    'feat.perf.title': 'ハイパフォーマンス',
    'feat.perf.desc': '中心窩レンダリング・クアッドレイヤー UI で Quest 3 90〜120FPS を目標',
    'feat.hand.title': 'ハンドトラッキング',
    'feat.hand.desc': 'コントローラ不要・6種のジェスチャ操作',
    'feat.audio.title': '空間オーディオ',
    'feat.audio.desc': 'HRTF ベースの3D定位サウンドで没入体験',
    'feat.ime.title': '日本語IME',
    'feat.ime.desc': 'ひらがな/カタカナ/漢字のネイティブ日本語入力',
    'feat.captions.title': 'VR内キャプション',
    'feat.captions.desc': 'すべての状態・エラーを調整可能なキャプションで表示 — 表示時間・サイズ・コントラストを自由に',
    'feat.reader.title': 'リーダービュー',
    'feat.reader.desc': 'あらゆるページを読みやすいページング済みテキストに整流 — お好みの距離で閲覧',
    'a11y.enterVR': 'VRモードに入る',
    'a11y.highContrast': '高コントラストの切り替え',
    'a11y.largeText': '大きな文字の切り替え',
    'a11y.langToggle': '言語の切り替え',
    // VR Settings Panel Labels (Accessibility)
    ...
    'vr.content.topSites': 'よくアクセスするサイト',
    'vr.content.topSitesHint': 'タイルを選択すると開きます',
    ...
    'vr.msg.smoothMoveWarning': 'スムーズ移動は酔いを引き起こすことがあります',
    ...
    'vr.msg.leftControllerDisconnected': '左コントローラが切断されました',
    'vr.msg.rightControllerDisconnected': '右コントローラが切断されました',
    'vr.msg.controllerDisconnected': 'コントローラが切断されました',
    'vr.msg.leftControllerReconnected': '左コントローラが再接続しました',
    'vr.msg.rightControllerReconnected': '右コントローラが再接続しました',
    'vr.msg.controllerReconnected': 'コントローラが再接続しました',
    'vr.msg.graphicsPaused': 'グラフィックスが一時停止 — 復元中',
    'vr.msg.graphicsRestored': 'グラフィックスを復元しました',
    'app.loading': 'Qui Browser VR を読み込んでいます…',
    ...
    'vr.msg.loadFailedPrefix': '読み込みに失敗しました',
    ...
    'vr.msg.historyEntryDeleted': '履歴項目削除',
    ...
    'vr.video.pause': '一時停止',
    'vr.video.exit': '終了',
    'vr.video.loadFailed': '動画を読み込めませんでした（URL・CORS を確認）',
