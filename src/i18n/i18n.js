...
const CATALOG = {
  en: {
    ...
    'vr.msg.loadStopped': 'Stopped loading',
    ...
    // the moment a command fires, so it always speaks in the current UI
    // language rather than the hardcoded Japanese these used to be.
    'vr.voice.wakeAck': "Yes, I'm listening",
    'vr.voice.commandFailed': 'Command execution failed',
    'vr.voice.commandNotRecognized': 'Command not recognized',
    'vr.voice.helpIntro': 'There are ',
    'vr.voice.helpIntroSuffix': ' available commands. ',
    'vr.voice.helpSeparator': ', ',
    'vr.voice.confirm.navigate': 'Going forward',
    'vr.voice.confirm.back': 'Going back',
    'vr.voice.confirm.refresh': 'Refreshing',
    'vr.voice.confirm.search': 'Searching',
    'vr.voice.vrEnterUnavailable': 'Voice cannot start VR — press the Enter VR button',
    'vr.voice.confirm.vrExit': 'Exiting VR mode',
    'vr.voice.volumeLevel': 'Volume',
    'vr.voice.volumeMax': 'Volume is already at maximum',
    'vr.voice.volumeMin': 'Volume is already at minimum',
    'vr.voice.imeHiragana': 'Hiragana input',
    'vr.voice.imeKatakana': 'Katakana input',
    'vr.voice.confirm.stopListening': 'Stopping voice recognition',
    'vr.voice.confirm.topSites': 'Opening your top site',
    'vr.voice.confirm.stopLoad': 'Stopping the page load',
    'vr.voice.confirm.clearHistory': 'Clearing history',
    'vr.voice.confirm.openLink': 'Opening link',
    'vr.voice.confirm.findInPage': 'Searching this page',
    'vr.voice.confirm.findNext': 'Next match',
    'vr.voice.confirm.bookmarks': 'Opening bookmarks panel',
    'vr.voice.confirm.bookmarksClose': 'Closing bookmarks panel',
    'vr.voice.confirm.keyboardOpen': 'Opening keyboard',
    'vr.voice.confirm.keyboardClose': 'Closing keyboard',
    'vr.voice.noPreviousPage': 'There is no previous page',
  ...
  ja: {
    ...
    'vr.msg.tab': 'タブ',
    'vr.msg.topSite': 'よく使うサイト',
    'vr.msg.openingSite': '開いています',
    ...
    'vr.msg.loadStopped': '読み込みを停止しました',
    ...
    'vr.voice.commandFailed': 'コマンドの実行に失敗しました',
    'vr.voice.commandNotRecognized': 'コマンドが認識できませんでした',
    'vr.voice.helpIntro': '使用可能なコマンドは、',
    'vr.voice.helpIntroSuffix': '個です。',
    'vr.voice.helpSeparator': '、',
    'vr.voice.confirm.navigate': '進みます',
    'vr.voice.confirm.back': '戻ります',
    'vr.voice.confirm.refresh': '更新します',
    'vr.voice.confirm.search': '検索します',
    'vr.voice.vrEnterUnavailable': '音声ではVRモードを開始できません。VR開始ボタンを押してください',
    'vr.voice.confirm.vrExit': 'VRモードを終了します',
    'vr.voice.volumeLevel': '音量',
    'vr.voice.volumeMax': '音量はすでに最大です',
    'vr.voice.volumeMin': '音量はすでに最小です',
    'vr.voice.imeHiragana': 'ひらがな入力にしました',
    'vr.voice.imeKatakana': 'カタカナ入力にしました',
    'vr.voice.confirm.stopListening': '音声認識を停止します',
    'vr.voice.confirm.topSites': 'よく使うサイトを開きます',
    'vr.voice.confirm.stopLoad': '読み込みを停止します',
    'vr.voice.confirm.clearHistory': '履歴を消去します',
    'vr.voice.confirm.openLink': 'リンクを開きます',
    'vr.voice.confirm.findInPage': 'ページ内を検索します',
    'vr.voice.confirm.findNext': '次の検索結果へ',
    'vr.voice.confirm.bookmarks': 'ブックマークパネルを開きます',
    'vr.voice.confirm.bookmarksClose': 'ブックマークパネルを閉じます',
    'vr.voice.confirm.keyboardOpen': 'キーボードを開きます',
    'vr.voice.confirm.keyboardClose': 'キーボードを閉じます',
    'vr.voice.noPreviousPage': '前のページはありません',
