...
export const ROWS = [
  ...
  [
    { label: 'esc', width: 1, glyph: '✕' },
    { label: 'かな', width: 1.5 },
    { label: 'space', width: 3, glyph: '␣' },
    { label: '変換', width: 1.5 },
    { label: 'enter', width: 2, glyph: '⏎' }
  ]
];
 ...
 */
export const SUGGESTION_MEASURE_EM = safeMeasureEm(SUGGESTION_BTN_PX_W - 24, SUGGESTION_LABEL_FONT_PX);
