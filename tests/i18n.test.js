...
// sites fixed", but both covered toasts and settings labels. Captions and
// screen-reader region labels were still English literals.
describe('captions and screen-reader labels are translated', () => {
  const KEYS = [
    'vr.a11y.captionsRegion', 'vr.a11y.alertsRegion', 'vr.a11y.settingsRegion',
    'vr.msg.teleported', 'vr.msg.recenterLabel', 'vr.msg.vrReady',
