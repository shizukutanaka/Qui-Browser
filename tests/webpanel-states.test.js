...
describe('WebPanel back / forward', () => {
  ...
  test('back() decrements index when history available', () => {
    const p = makePanel();
    p.history = ['https://a.com', 'https://b.com'];
    p.historyIdx = 1;
    p.back();
  ...
  test('forward() is a no-op when no forward history', () => {
    const p = makePanel();
    p.history = ['https://a.com'];
    p.historyIdx = 0;
    p.forward();
  ...
  test('forward() increments index when forward history available', () => {
    const p = makePanel();
    p.history = ['https://a.com', 'https://b.com'];
    p.historyIdx = 0;
    p.forward();
  ...
  test('back then forward roundtrips the index', () => {
    const p = makePanel();
